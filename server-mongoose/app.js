...
mongoose.connection.on("connected", async function () {
    ...
    if (setting.length == 0) {
        ...
        let newSetting = new Setting({
            siteTitle: "Paste Share",
            siteSEOTitle: "Paste Share - Aplikasi web berbagi paste",
            siteDescription: "Paste Share adalah aplikasi web berbagi paste...",
            siteSEODescription: "Paste Share adalah aplikasi web berbagi paste...",
